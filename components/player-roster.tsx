...
interface PlayerRosterProps {
  search: string
  /** Called after a successful kick/ban so the caller can refresh its roster. */
  onAfterAction?: () => void
...
// and watchlist toggle. Rendered by the full-admin sidebar (OnlinePlayersPanel)
// and by the mod-tier ModWidget.
// Accounts hidden from the MOD-tier widget only. Configured as a comma-separated
// list of exact userIds in NEXT_PUBLIC_MOD_WIDGET_HIDDEN_USERIDS (empty by
// default). Exact match — the admin sidebar always shows everyone.
const MOD_WIDGET_HIDDEN_USERIDS = new Set<string>(
